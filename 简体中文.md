...
[MarkDoc／标档（v0.11）](https://GitHub.com/LongTengDao/MarkDoc/)
========================
...
### [2.5 Pre-预格式块](#user-content-2.5)<a id="user-content-2.5">&nbsp;</a>
...
### [2.6 Semantic–语义块](#user-content-2.6)<a id="user-content-2.6">&nbsp;</a>
...
| `普通文本^^上标^^//下标//`<br>`普通文本//下标//^^上标^^` | `普通文本<small style="display:inline-block;vertical-align:-0.5em;">上标<br />下标</small>`<br>`normal<small style="display:inline-block;vertical-align:-0.5em;">下标<br />上标</small>` |
