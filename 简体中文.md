...
| `普通文本^^上标^^//下标//`<br>`普通文本//下标//^^上标^^` | `普通文本<small style="display:inline-block;vertical-align:-0.5em;">`<br>`上标<br />下标</small>`<br>`普通文本<small style="display:inline-block;vertical-align:-0.5em;">`<br>`下标<br />上标</small>` |
